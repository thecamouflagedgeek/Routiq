  ...
  return (
    <>
      ...
      <header
        ...
        style={{
          background: dark ? 'rgba(18, 18, 21, 0.85)' : 'rgba(255, 255, 255, 0.88)',
      ...
      <div className="fixed bottom-3 inset-x-3 z-[1200] md:hidden flex justify-center items-center pointer-events-none">
        <div
          ...
          style={{
            background: dark ? 'rgba(18, 18, 21, 0.92)' : 'rgba(255, 255, 255, 0.95)',
          ...
          {LINKS.map((l) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] font-extrabold mt-0.5 tracking-tight">{l.label}</span>
              </button>
            )
          })}
        </div>
