...
export function HazardForm({
  ...
  const [submitted, setSubmitted] = useState<Hazard | null>(null);
  ...
  return (
    <div
      ...
      onClick={picking ? undefined : closeAll}
    >
      <div
        ...
        {submitted ? (
          <div className="flex flex-col items-center py-4 text-center">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Thanks — this hazard is now visible to other drivers on the map.
            </p>
            <button
              onClick={closeAll}
              className="mt-5 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-neutral-900 py-3 text-sm font-bold text-white transition-colors hover:bg-neutral-700"
            >
              Done
            </button>
          </div>
          ...
          <>
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-neutral-400">
                  Help other drivers — reports appear on the map instantly.
                </p>
              </div>
              <button
                onClick={closeAll}
                className="cursor-pointer rounded-full p-1.5 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-900"
              >
                <X size={17} />
              </button>
            </div>
              ...
              <div className="mt-1.5 flex gap-1.5">
                {(Object.keys(SEVERITY_META) as HazardSeverity[]).map((s) => (
                  <button
                    ...
                    style={
                      severity === s
                        ? { backgroundColor: SEVERITY_META[s].color }
                        : undefined
                    }
                  >
            ...
            <div className="mb-3">
              ...
              <div className="mt-1.5 flex items-center gap-2 rounded-lg border border-neutral-200 px-3 py-2">
                ...
                <span
                  className={`flex-1 truncate text-xs font-medium ${location ? "text-neutral-900" : "text-neutral-400"}`}
                >
                  {locationLabel}
                </span>
                {picking && (
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-900 outline-none placeholder:text-neutral-400 focus:border-neutral-400"
              />
            </div>
