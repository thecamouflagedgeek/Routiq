        ...
        <div className="min-w-[150px]">
          ...
          <div className="mt-1 flex items-center gap-2 text-[11px] text-neutral-500">
            <span
              ...
              style={{
                backgroundColor: `${SEVERITY_META[hazard.severity].color}1a`,
                color: SEVERITY_META[hazard.severity].color,
              }}
            >
              {SEVERITY_META[hazard.severity].label} severity
            </span>
            {hazard.distance_m != null && (
              <span>{Math.round(hazard.distance_m)} m away</span>
            )}
          </div>
        </div>
      </Popup>
